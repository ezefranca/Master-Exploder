...
ifeq ($(OS),Windows_NT)
	LIBS = -lallegro -lallegro_main -lallegro_primitives -lallegro_audio -lallegro_acodec -lallegro_primitives -lallegro -lallegro_font -lallegro_image -lopencv_core300 -lopencv_highgui300 -lallegro_ttf
else
